...
public class Notebook {
    ...
    public static void menu() {
        System.out.print("""
                ...
                выбор диаганали        -  1
                выбор Макс. объем RAM  -  2
                выбор жесткого диска   -  3
                выбора типа ОС         -  4
                выбор цвета            -  5
                задать все пареметры   -  6
                Ваше решение: \s""");
    }
    ...
    public static Set<Object> normDemands(Set<Notebook> mySet) {
        ...
        String text1 = """
                В настоящее время доступны ноутбуки, имеющие следующие диаганали: 
                - 14.5 дюймов;
                - 15.6 дюймов;
                - 17.3 дюйма.
        ...
        String text2 = """
                В настоящее время доступны ноутбуки, имеющие максимальный объем ОЗУ: 
                - 4  ГБ;
                - 8  ГБ;
                - 16 ГБ.
                Введите нужное значение: \s""";
        ...
        String text3 = """
                В настоящее время доступны ноутбуки, имеющие следующие объемы ЖД:
                - 1000 ГБ;
                - 512  ГБ;
                - 500  ГБ;
                - 256  ГБ.
        ...
        String text4 = """
                В настоящее время доступны ноутбуки, имеющие следующие операционные системы:
                - Windows10;
                - Windows11;
                - MacOS.
                Введите нужную ОС: \s""";
        ...
        String text5 = """
                В настоящее время доступны ноутбуки, следующих цветов:
                - silver;
                - gray;
                - black.
    ...
    public static void result(Set<Notebook> mySet, Set<Object> request) {
        ...
        if (!flag) {
            System.out.println("\nК сожалению товаров с указанными характеристиками сейчас нет. " +
                    "Проконсультироваться о возможности заказа ноутбуков можно у менеджера");
        }
    }
